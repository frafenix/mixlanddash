...
export default function PresenzePage() {
  ...
  // Funzione per verificare se l'utente può accedere alle funzionalità team
  const canAccessTeamFeatures = () => {
    ...
    if (isDevelopment && typeof window !== 'undefined') {
      ...
      if (mockRole) {
        return ['manager', 'admin'].includes(mockRole);
      }
    }
    
    // Fallback to user context role
    return user?.role && ['ADMIN', 'MANAGER'].includes(user.role);
  };
