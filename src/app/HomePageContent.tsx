      ...
      <section id="pricing" className="py-20 bg-gray-50 dark:bg-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row gap-8 max-w-6xl mx-auto">
            {/* Free Plan */}
            <div className="bg-white dark:bg-slate-900 rounded-lg shadow-lg p-8 border border-gray-200 dark:border-slate-700 flex-1">
            ...
            {/* Starter Plan */}
            <div className="bg-white dark:bg-slate-900 rounded-lg shadow-lg p-8 border-2 border-blue-500 relative flex-1">
            ...
            {/* Pro Plan */}
            <div className="bg-white dark:bg-slate-900 rounded-lg shadow-lg p-8 border-2 border-purple-500 relative flex-1">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <span className="bg-purple-500 text-white px-4 py-1 rounded-full text-sm font-medium flex items-center">
                  <Icon path={mdiCrown} size="16" className="mr-1" />
                  Premium
                </span>
              </div>
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center">
                  <Icon path={mdiCheck} size="20" className="text-purple-500 mr-3" />
                  <span className="text-gray-700 dark:text-gray-300">Supporto dedicato 24/7</span>
                </li>
                <li className="flex items-center">
                  <Icon path={mdiCheck} size="20" className="text-purple-500 mr-3" />
                  <span className="text-gray-700 dark:text-gray-300">Onboarding personalizzato</span>
                </li>
              </ul>
              ...
              <button
                ...
                disabled={isLoading}
                className="group w-full bg-purple-600 text-white py-4 px-6 rounded-xl text-center font-semibold hover:bg-purple-700 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/25 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              >
                <span className="flex items-center justify-center gap-2">
                  {isLoading ? 'Caricamento...' : 'Inizia con Pro'}
                  {!isLoading && (
                    <svg className="w-5 h-5 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                    </svg>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center slide-up-delay-2">
            ...
            <button
              onClick={handleStarterPlanClick}
              disabled={isLoading}
              className="group bg-transparent border-2 border-white text-white px-10 py-4 rounded-2xl text-lg font-semibold hover:bg-white hover:text-blue-600 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl inline-flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
            >
